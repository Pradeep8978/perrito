  ...
  render() {
    ...
    return (
      <MowContainer
        ...
        <MowInfoHeader activeIndex={2} />

        <KeyboardAwareScrollView style={[pageContainerStyle, {marginTop: 20}]}>
          {/* credit card view */}
          <View
            style={[
            ...
            <View
              ...
              <View
                ...
                <MowCheckBox
                  onPress={() => {
                    this.setState({creditCard: true, paypal: false});
                  }}
              ...
              <View
                ...
                <View style={[paymentStyle.logoView, {marginLeft: 10}]}>
            ...
            {this.state.creditCard && (
              <View style={{paddingHorizontal: wp('3%')}}>
                ...
                <MowInput
                  onChangeText={value =>
                    this.onChangeText('cardOwnerName', value)
                  }
                ...
                <View style={{flexDirection: 'row'}}>
                  ...
                  <MowInput
                    ...
                    onChangeText={value =>
                      this.onChangeText('expiryDate', value)
                    }
          ...
          <View
            ...
            <MowCheckBox
              onPress={() => {
                this.setState({creditCard: false, paypal: true});
              }}
              checkedColor={mowColors.mainColor}
