...
export default class RateProduct extends React.Component {
  ...
  render() {
    ...
    return (
      <MowContainer title={mowStrings.rateProduct.title}>
        <KeyboardAwareScrollView
          ...
          <View
            ...
            {/* product summary */}
            <MowProductInfoView product={product} />
          </View>
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() =>
                this._handleStarSelection(true, false, false, false, false)
              }
              style={starStyle.container}>
              {/* star view */}
              <View style={starStyle.starView}>
                <MowStarView score={5} />

                <Text style={starStyle.text}>5 {mowStrings.star}</Text>
              </View>
            ...
            <TouchableOpacity
              onPress={() =>
                this._handleStarSelection(false, true, false, false, false)
              }
              style={starStyle.container}>
              {/* star view */}
              <View style={starStyle.starView}>
                ...
                <Text style={starStyle.text}>4 {mowStrings.star}</Text>
              </View>
            ...
            <TouchableOpacity
              onPress={() =>
                this._handleStarSelection(false, false, true, false, false)
              }
              style={starStyle.container}>
              {/* star view */}
              <View style={starStyle.starView}>
                ...
                <Text style={starStyle.text}>3 {mowStrings.star}</Text>
              </View>
            ...
            <TouchableOpacity
              onPress={() =>
                this._handleStarSelection(false, false, false, true, false)
              }
              style={starStyle.container}>
              {/* star view */}
              <View style={starStyle.starView}>
                ...
                <Text style={starStyle.text}>2 {mowStrings.star}</Text>
              </View>
            ...
            <TouchableOpacity
              onPress={() =>
                this._handleStarSelection(false, false, false, false, true)
              }
              style={starStyle.container}>
              {/* star view */}
              <View style={starStyle.starView}>
                ...
                <Text style={starStyle.text}>1 {mowStrings.star}</Text>
              </View>
