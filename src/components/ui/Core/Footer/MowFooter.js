    ...
    <View
      ...
      <TouchableOpacity
        ...
        <FatherIcon
          ...
          style={[
            styles.buttonIcon,
            {color: props.activeIndex === 1 ? mowColors.mainColor : '#a1a1a1'},
          ]}
        />
      ...
      <TouchableOpacity
        ...
        <FatherIcon
          ...
          style={[
            styles.buttonIcon,
            {color: props.activeIndex === 3 ? mowColors.mainColor : '#a1a1a1'},
          ]}
        />
      ...
      <TouchableOpacity
        ...
        <FatherIcon
          ...
          style={[
            styles.buttonIcon,
            {color: props.activeIndex === 4 ? mowColors.mainColor : '#a1a1a1'},
          ]}
        />
